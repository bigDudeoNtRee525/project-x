...
import { Plus, RefreshCw, FileText, Clock, CheckCircle, XCircle, Calendar, X } from 'lucide-react';
        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-600 mt-1">View uploaded meeting transcripts and their extracted tasks</p>
                </div>
                <div className="flex items-center space-x-3">
                    <Button variant="outline" onClick={loadMeetings} disabled={isLoading} className="flex items-center space-x-1">
                        <RefreshCw className={`h-4 w-4 ${isLoading ? 'animate-spin' : ''}`} />
                        <span>Refresh</span>
                    </Button>
                    <Button onClick={() => setUploadModalOpen(true)} className="flex items-center space-x-1">
                                        ...
                                        <CardContent className="py-4">
                                            <div className="flex items-start justify-between">
                                                ...
                                                <div className="text-right">
                                                    <div className="text-2xl font-bold text-gray-900">{meeting._count?.tasks || 0}</div>
