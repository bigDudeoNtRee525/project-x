...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    console.log('DashboardLayout mounted', { isAuthenticated, isLoading });
  }, []);
  ...
  // Always render dashboard without authentication check
  // The page itself handles the auth redirect logic
